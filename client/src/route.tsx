...
const [Home, Login, MenuAdmin, PowerAdmin, RoleAdmin, UserAdmin, DebugClients, DebugTerminal, LogAdmin] = [
  ...
  () => import("@/pages/debug/debug_clients"),
  () => import("@/pages/debug/debug_terminal"),
  () => import("@/pages/system/log_admin"),
].map((item: any) => {
