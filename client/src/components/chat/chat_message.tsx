...
export default function ChatMessage(props: ChatMessageProps) {
  return (
    <div className={`mb-4 w-full flex ${props.leftOrRight ? "" : " text-right"}`}>
      <div className="flex-2">{props.leftOrRight ? props.client_name + ":" : ""}</div>
      <div className="flex-1 px-2 flex-col">
        <div
          className={`inline-block  rounded-full p-2 px-6 text-gray-700 ${props.leftOrRight ? " bg-gray-200" : " bg-blue-600"}`}
        >
